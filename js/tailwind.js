...
(() => {
    ...
    for (let i = r + 1; i < t.length; i++)
      if (((o = t.charCodeAt(i)), 92 === o)) i += 1;
        ...
        if (
          59 === o &&
          (t.charCodeAt(i + 1) === e ||
            (13 === t.charCodeAt(i + 1) && t.charCodeAt(i + 2) === e))
        )
          throw new Error(
            `Unterminated string: ${t.slice(r, i + 1) + String.fromCharCode(n)}`
          );
        if (o === e || (13 === o && t.charCodeAt(i + 1) === e))
          throw new Error(
            `Unterminated string: ${t.slice(r, i) + String.fromCharCode(n)}`
          );
      }
    return r;
  }
  ...
  function j(e, t, r = [], n = {}) {
    for (let o = 0; o < e.length; o++) {
      ...
      if ("rule" === i.kind || "at-rule" === i.kind)
        r.push(i), j(i.nodes, t, r, n), r.pop();
  ...
  var we = new RegExp(
    `^${ue.source}(${["deg", "rad", "grad", "turn"].join("|")})$`
  );
  ...
  function Me(e, t, r, n, o = "") {
    ...
    return i
      ? [
          x(e, l(je(t, n))),
          y("@supports (color: lab(from red l a b))", [x(e, l(a))]),
        ]
      : [x(e, l(a))];
  }
  ...
  function Ze(e) {
    ...
    return (
      ...
      (function (e) {
        ...
        let i = [];
        for (let e of t)
          for (let t of e.items) i.push([t.name, { modifiers: t.modifiers }]);
        return i;
      })(r)
    );
  }
  ...
  function et(e) {
    let t = (function (e) {
        ...
        function n(e, r) {
          t.static(e, () =>
            r.map((e) => ("function" == typeof e ? e() : x(e[0], e[1])))
          );
        }
        function o(n, o) {
        ...
        t.static("container", () => {
          ...
          let r = [
            x("--tw-sort", "--tw-container-component"),
            x("width", "100%"),
          ];
          for (let e of t)
          ...
          t.functional("flex", (e) => {
            if (e.value) {
              ...
              if (e.value.fraction) {
                ...
                return be(t) && be(r)
                  ? [x("flex", `calc(${e.value.fraction} * 100%)`)]
                  : void 0;
              }
              if (be(e.value.value))
                return e.modifier ? void 0 : [x("flex", e.value.value)];
        ...
        let f = () =>
          z([Ve("--tw-pan-x"), Ve("--tw-pan-y"), Ve("--tw-pinch-zoom")]);
        ...
        n("grid-flow-row", [["grid-auto-flow", "row"]]),
          ...
          o("grid-cols", {
            ...
            handleBareValue: ({ value: e }) =>
              ye(e) ? `repeat(${e}, minmax(0, 1fr))` : null,
          ...
          ]);
        {
          ...
          i("border", {
            width: (e) => [
              x("border-style", "var(--tw-border-style)"),
              x("border-width", e),
            ],
            ...
            if (t.value) {
              if ("arbitrary" === t.value.kind) {
                ...
                switch (
                  ...
                  case "percentage":
                    return t.modifier || !be(r.slice(0, -1))
                      ? void 0
                      : o.position(r);
                  default:
                    return t.modifier ? void 0 : o.position(r);
              ...
              }
              {
                ...
                switch (r) {
                  ...
                  case "percentage":
                    return be(t.value.value.slice(0, -1))
        ...
        o("mask-linear", {
          ...
          supportsFractions: !1,
          handleBareValue: (e) =>
            be(e.value) ? `calc(1deg * ${e.value})` : null,
          ...
          t.functional("stroke", (t) => {
            if (t.value) {
              if ("arbitrary" === t.value.kind) {
                ...
                switch (
                  t.value.dataType ??
                  ie(r, ["color", "number", "length", "percentage"])
                ) {
                  case "number":
                  case "length":
                  case "percentage":
          ...
          t.functional("font", (t) => {
            if (t.value && !t.modifier) {
              if ("arbitrary" === t.value.kind) {
                ...
                switch (
                  t.value.dataType ??
                  ie(e, ["number", "generic-name", "family-name"])
                ) {
                  case "generic-name":
                  case "family-name":
            ...
            t.functional("backdrop-filter", (e) => {
              if (!e.modifier) {
                ...
                if ("none" === e.value.value)
                  return [
                    x("-webkit-backdrop-filter", "none"),
                    x("backdrop-filter", "none"),
                  ];
              }
            }),
            o("blur", {
                  ...
                  "arbitrary" === t.value.kind
                    ...
                    : ((n = e.resolve(t.value.fraction ?? t.value.value, [
                      ...
                      null === n &&
                        ...
                        (n = `${t.value.value}ms`)),
                  null !== n
                    ? [r(), x("--tw-duration", n), x("transition-duration", n)]
                    : void 0
                );
              });
          }
          ...
          n("ease-initial", [e, ["--tw-ease", "initial"]]),
            ...
            o("ease", {
              ...
              handle: (t) => [
                e(),
                x("--tw-ease", t),
                x("transition-timing-function", t),
              ],
            });
        }
          ...
          t.static("outline-hidden", () => [
            ...
            t.functional("outline", (t) => {
              ...
              if ("arbitrary" === t.value.kind) {
                ...
                switch (
                  t.value.dataType ??
                  ie(r, ["color", "length", "number", "percentage"])
                ) {
                  case "length":
                  case "number":
                  case "percentage":
        ...
        let T = () =>
          z([
            Ve("--tw-text-shadow-color"),
            Ve("--tw-text-shadow-alpha", "100%", "<percentage>"),
          ]);
          ...
          t.functional("text-shadow", (t) => {
            ...
            switch (t.value.value) {
              ...
              case "inherit":
                return t.modifier
                  ? void 0
                  : [T(), x("--tw-text-shadow-color", "inherit")];
            }
            {
          ...
          ]);
        {
            ...
            t.functional("shadow", (t) => {
              ...
              switch (t.value.value) {
                case "none":
                  return t.modifier
                    ? void 0
                    : [s(), x("--tw-shadow", l), x("box-shadow", a)];
                case "inherit":
                  return t.modifier
                    ? void 0
                    : [s(), x("--tw-shadow-color", "inherit")];
              }
              {
              ...
              }
              {
                ...
                if (r)
                  return [
                    s(),
                    x("--tw-shadow-color", Ne(r, "var(--tw-shadow-alpha)")),
                  ];
              }
            }),
            r("shadow", () => [
            ...
            t.functional("inset-shadow", (t) => {
                    ...
                    null === n
                      ...
                      : [
                          ...
                          x(
                            ...
                            Ne(n, "var(--tw-inset-shadow-alpha)")
                          ),
                        ])
                  : [
                      s(),
              ...
              switch (t.value.value) {
                case "none":
                  return t.modifier
                    ? void 0
                    : [s(), x("--tw-inset-shadow", l), x("box-shadow", a)];
                case "inherit":
                  return t.modifier
                    ? void 0
                    : [s(), x("--tw-inset-shadow-color", "inherit")];
              }
              {
              ...
              }
              {
                ...
                if (r)
                  return [
                    ...
                    x(
                      "--tw-inset-shadow-color",
                      Ne(r, "var(--tw-inset-shadow-alpha)")
                    ),
                  ];
              }
            }),
          ...
          t.functional("ring", (t) => {
            ...
            if ("arbitrary" === t.value.kind) {
              let r = t.value.value;
              return "length" ===
                (t.value.dataType ?? ie(r, ["color", "length"]))
                ? t.modifier
                  ? void 0
            ...
            }
            {
              ...
              if (
                (null === r && be(t.value.value) && (r = `${t.value.value}px`),
                r)
              )
                return [s(), x("--tw-ring-shadow", o(r)), x("box-shadow", a)];
            }
          ...
          t.functional("@container", (e) => {
            ...
            if (
              ...
              return e.modifier
                ? [
                    x("container-type", t),
                    x("container-name", e.modifier.value),
                  ]
                : [x("container-type", t)];
          }),
          r("@container", () => [
        ...
        r("first", ["&:first-child"]),
          ...
          t.functional("nth", (e, t) => {
            if (
              !t.value ||
              t.modifier ||
              ("named" === t.value.kind && !be(t.value.value))
            )
              return null;
            ...
            let r = (function (e, t, r) {
              ...
              for (let r of n) {
                ...
                for (let r of e.variants)
                  if (null === nt(i, r, t.variants)) return [];
  ...
  function nt(e, t, r, n = 0) {
    if ("arbitrary" === t.kind)
      return t.relative && 0 === n
        ? null
        : void (e.nodes = [y(t.selector, e.nodes)]);
    let { applyFn: o } = r.get(t.root);
    if ("compound" === t.kind) {
      let i = b("@slot");
      if (
        null === nt(i, t.variant, r, n + 1) ||
    ...
    C([n], (e, { parent: n, path: l }) => {
      if ("at-rule" === e.kind) {
        ...
        if ("@apply" === e.name) {
          ...
          (r |= 1), o.add(n);
          for (let r of st(e, t))
            for (let t of l) t !== e && o.has(t) && i.get(t).add(r);
        }
      }
    });
    let l = new Set(),
    ...
    function d(e, r = []) {
      if (!l.has(e)) {
        ...
        for (let t of i.get(e))
          for (let n of a.get(t)) r.push(e), d(n, r), r.pop();
    ...
    return function (n, o) {
      ...
      let s = (() => {
        ...
        if (null !== s && "object" == typeof s && !Array.isArray(s)) {
          ...
          for (let t in i)
            "__CSS_VALUES__" !== t &&
              ((4 & s?.__CSS_VALUES__?.[t] && void 0 !== kt(e, t.split("-"))) ||
                (e[a(t)] = i[t]));
          return e;
        }
  ...
  function Yt(e, { config: t, base: r, path: n, reference: o, src: i }) {
    ...
    for (let a of t.presets ?? [])
      Yt(e, { path: n, base: r, config: a, reference: o, src: i });
    for (let t of a)
      e.plugins.push(t),
        t.config &&
          Yt(e, {
    ...
    let n = (function ({ center: e, padding: t, screens: r }, n) {
      ...
      if (
        ...
        if ((e.sort((e, t) => te(e[1], t[1], "asc")), e.length > 0)) {
          let [t] = e[0];
          o.push(
            b("@media", `(width >= --theme(--breakpoint-${t}))`, [
              x("max-width", "none"),
            ])
          );
        }
  ...
  async function sr(
    e,
    { base: t = "", from: r, loadModule: n = ar, loadStylesheet: o = lr } = {}
  ) {
    let l = 0;
    ...
    let E = et(u);
    if ((s && (E.important = s), T.length > 0))
      for (let e of T) E.invalidCandidates.add(e);
    l |= await er({
      designSystem: E,
      base: t,
      ast: e,
  ...
  async function kr(e, t) {
    try {
      ...
      return (
        wr.hit("Loaded stylesheet", { id: e, base: t, size: r.content.length }),
        r
      );
    } catch (r) {
      throw (
        (wr.hit("Failed to load stylesheet", {
          id: e,
          base: t,
          error: r.message ?? r,
        }),
